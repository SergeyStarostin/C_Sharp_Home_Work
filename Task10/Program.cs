...
int number = InputInt("Введите число N, до которого выдадим значения в 3 степени: ");  //запуск функции ввода числа number

for (int i = 1; i <= number; i++)       //у цикла for Три параметра: 1 - инициализация, 2 - условие продолжение, 3 - команда в конце каждого цикла
{
    int cube = i * i * i;             //заводим переменную равную кубу счетчика
    System.Console.Write($" {cube} |"); //вывод чисел в 3 степени на экран в одну строку
}